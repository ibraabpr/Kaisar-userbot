...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"**• ᴍᴀᴀꜰ ᴋᴀɪꜱᴀʀ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!**",
    f"**• ᴍᴀᴀꜰ ᴋᴀɪꜱᴀʀ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ\n • ᴛᴜɴɢɢᴜ ꜱᴀᴍᴘᴀɪ ᴅɪᴀ ᴋᴇᴍʙᴀʟɪ ᴏɴʟɪɴᴇ!**",
    f"**• ᴋᴀɪꜱᴀʀ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!\n • ᴛᴜɴɢɢᴜʟᴀʜ ꜱᴀᴍᴘᴀɪ ᴏɴʟɪɴᴇ!**",
    f"**• ᴍᴀᴀꜰ ᴋᴀɪꜱᴀʀ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!**",
]
...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"ཌKαisαrད\n**• ᴋᴀɪꜱᴀʀ ᴛᴇʟᴀʜ ᴀꜰᴋ**\
        \n**• ᴀʟᴀꜱᴀɴ :** `{string}`")
    else:
        await afk_e.edit("ཌKαisαrད\n**• ᴋᴀɪꜱᴀʀ ᴛᴇʟᴀʜ ᴀꜰᴋ**")
    if user.last_name:
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("**ᴋᴀɪꜱᴀʀ ᴛᴇʟᴀʜ ᴋᴇᴍʙᴀʟɪ !!**")
        time.sleep(3)
        await msg.delete()
        ...
        if ISAFK:
            ...
            if mention.sender_id not in USERS:
                ...
                if USERS[mention.sender_id] % randint(2, 4) == 0:
                    if AFKREASON:
                        await mention.reply(f"ཌKαisαrད\n**ᴋᴀɪꜱᴀʀ ᴍᴀꜱɪʜ ᴀꜰᴋ** {afk_since} **ʏᴀɴɢ ʟᴀʟᴜ.**\
                            \n**• ᴀʟᴀꜱᴀɴ :** `{AFKREASON}`")
                    else:
                        await mention.reply(str(choice(AFKSTR)))
